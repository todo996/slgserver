...
REVOKE ALL ON TABLE
    public.tb_user_info,
    public.tb_login_history,
    public.tb_login_last,
    public.tb_role_1,
    public.tb_map_role_city_1,
    public.tb_map_role_build_1,
    public.tb_city_facility_1,
    public.tb_role_res_1,
    public.tb_general_1,
    public.tb_army_1,
    public.tb_war_report_1,
    public.tb_coalition_1,
    public.tb_coalition_apply_1,
    public.tb_role_attribute_1,
    public.tb_coalition_log_1,
    public.tb_skill_1
